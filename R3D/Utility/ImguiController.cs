...
namespace R3D.Utility
{
    ...
    public class ImguiController : IDisposable
    {
        ...
        unsafe void LoadFontTexture()
        {
            ...
            io.Fonts.SetTexID(new nint(fontTexture.id));
        ...
        void DrawTriangles(uint count, int idxOffset, int vtxOffset, ImVector<ushort> idxBuffer, ImPtrVector<ImDrawVertPtr> idxVert, nint textureId)
        {
            ushort index = 0;
